  ...
  const profileData = [
    {
      ...
      skills: ["User Research", "Figma", "Design Systems", "Prototyping", "Accessibility"],
      interests: ["Public Speaking", "FinTech", "Coffee", "Travel"],
    ...
    },
    {
      ...
      interests: ["Design Systems", "Open Source", "Web3", "FinTech"],
      lookingFor: ["Co-founders", "Collaborators"],
    },
    {
      userId: sarahM.id,
      aboutMe:
      ...
      company: "Airbnb",
      skills: ["UX/UI", "Figma", "Prototyping", "User Research"],
      interests: ["Travel", "Hospitality Tech", "Design"],
      lookingFor: ["Mentors", "Learning Partners"],
    },
    {
      userId: marcus.id,
      aboutMe:
      ...
      skills: ["Startups", "AI", "Leadership", "Python", "Strategy"],
      interests: ["Startups", "AI", "Venture Capital"],
      lookingFor: ["Tech Leads", "Hiring Talent", "Investors"],
    },
    {
      userId: elena.id,
      ...
      company: "Google",
      skills: ["Python", "TensorFlow", "ML/AI", "Data Science"],
      interests: ["AI", "Open Source", "Education"],
      lookingFor: ["Collaborators", "Learning Partners"],
    },
    {
      userId: james.id,
      ...
      interests: ["DevOps", "Cloud Native", "Open Source"],
      lookingFor: ["Collaborators", "Job Opportunities"],
    },
    {
      userId: priya.id,
      ...
      company: "Shopify",
      skills: ["Ruby", "React", "GraphQL", "TypeScript", "APIs"],
      interests: ["E-commerce", "Developer Experience", "Startups"],
      lookingFor: ["Co-founders", "Mentors"],
    },
    {
      userId: alex.id,
      ...
      skills: ["Venture Capital", "Strategy", "FinTech"],
      interests: ["Startups", "FinTech", "AI", "Developer Tools"],
      lookingFor: ["Co-founders", "Hiring Talent"],
    },
    {
      userId: mia.id,
      ...
      company: "Figma",
      skills: ["React", "CSS", "Design Systems", "TypeScript", "Figma"],
      interests: ["Design", "Developer Experience", "Open Source"],
      lookingFor: ["Collaborators", "Learning Partners"],
    },
    {
      userId: omar.id,
      ...
      company: "Tesla",
      skills: ["C++", "Python", "Embedded Systems", "AI", "Robotics"],
      interests: ["Autonomous Vehicles", "Robotics", "AI", "Hardware"],
      lookingFor: ["Collaborators", "Mentors"],
    },
  ];
